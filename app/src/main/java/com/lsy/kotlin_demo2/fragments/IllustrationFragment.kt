...
class IllustrationFragment : Fragment() {
    private lateinit var mBinding: FragmentIllustrationBinding
    private lateinit var galleryAdapter: GalleryAdapter
    private lateinit var mViewModel: IllustrationViewModel
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentIllustrationBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ).get(IllustrationViewModel::class.java)
